  ...
  return (
    <footer className="bg-pink-100 text-gray-700 py-10">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Bottom Section - Copyright and Creator Info */}
        <div className="border-t border-gray-300 mt-10 pt-4 text-center text-pink-700">
          <p>© {new Date().getFullYear()} All Rights Reserved.</p>
          <p className="mt-1">Created by <strong>NTechzy Pvt. Ltd.</strong></p>
        </div>
      </div>
    </footer>
  );
