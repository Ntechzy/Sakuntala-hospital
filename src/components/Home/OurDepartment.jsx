  ...
  return (
    <div>
      <div>
        ...
        <h3 className='text-lg text-center md:w-[70%] m-auto p-3'> our department Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, sint. Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quod, dignissimos. </h3>
      </div>
